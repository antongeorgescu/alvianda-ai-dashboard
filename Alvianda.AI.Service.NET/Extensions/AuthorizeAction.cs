...
namespace Alvianda.AI.Service.CoreNet.Extensions
{
    public class AuthorizePermission : System.Web.Mvc.AuthorizeAttribute, Microsoft.AspNetCore.Mvc.Filters.IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            // read permissions from external database
            object MockData;
            var assignedPermissionsForUser = MockPermissionsData.UserPermissions.Where(x => x.Key == userName).Select(x => x.Value).ToList();
